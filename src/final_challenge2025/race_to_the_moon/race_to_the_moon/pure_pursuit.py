...
class PurePursuit(Node):
    ...
    def __init__(self):
        ...
        self.traj_sub = self.create_subscription(Trajectory, "/race/trajectory", self.trajectory_callback, 1)
    ...
    def trajectory_callback(self, msg):
        ...
        if len(msg.points) < 2:
            self.get_logger().warning("Received trajectory with less than 2 points. Ignoring.")
            return
