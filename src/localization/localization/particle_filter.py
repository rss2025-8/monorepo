...
from geometry_msgs.msg import PoseWithCovarianceStamped, Pose, Point, Quaternion, PoseArray
...
class ParticleFilter(Node):
    ...
    def pose_callback(self, initial_pose: PoseWithCovarianceStamped) -> None:
        self.particles = np.tile(pose_to_vec(initial_pose.pose.pose), (self.num_particles, 1)) + np.random.normal(scale=0.1, size=(self.num_particles, 3))
    ...
    def odom_callback(self, odom: Odometry) -> None:
        ...
        self.get_logger().info(f"{delta_pose}")
